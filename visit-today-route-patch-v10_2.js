window.patchRadarVisitTodayRouteV102=function(html){
const CSS=String.raw`
/* Radar Local V10.2 — fixed field route for 17 Aug 2026 */
.v102-route-banner{display:flex;align-items:center;justify-content:space-between;gap:12px;margin:0 0 10px;padding:10px 12px;border:1px solid #cfe0f5;border-radius:12px;background:#f6faff;color:#36536f}.v102-route-banner div{min-width:0}.v102-route-banner span{display:block;font-size:7px;font-weight:900;letter-spacing:.08em;color:#1769e0}.v102-route-banner b{display:block;margin-top:2px;font-size:10px}.v102-route-banner em{flex:0 0 auto;border-radius:999px;background:#e9f8f1;color:#0d8554;padding:6px 8px;font-size:7px;font-style:normal;font-weight:900}
@media(max-width:700px){.v102-route-banner{padding:9px 10px}.v102-route-banner b{font-size:9px}.v102-route-banner em{font-size:6.5px}}
`;
const JS=String.raw`
(function(){
const ROUTE_DATE='2026-08-17';
const IDS=['11055226','9845804','10821806','7197654','11281677','9534743','10771471','4408429','9318952'];
...
const MARKER_KEY='radar_visit_route_seed_2026_08_17_v102';
...
function decorate(){
 ...
 if(!page||!shell||page.querySelector('.v102-route-banner'))return;
 const banner=document.createElement('div');banner.className='v102-route-banner';
 banner.innerHTML='<div><span>RUTA CARGADA · HOY</span><b>La Abuelita → Fidelio → Ameyalli → Cafenatlan → Aroma → Breve → Mr Rocco → Vero → Fragolina</b></div><em>9 paradas · 09:00</em>';
 shell.parentElement.insertBefore(banner,shell);
}
seed();
setTimeout(decorate,350);setTimeout(decorate,1000);
new MutationObserver(decorate).observe(document.body,{childList:true,subtree:true});
window.radarTodayRouteV102={version:'10.2',date:ROUTE_DATE,ids:IDS.slice(),start:'09:00',restore:function(){localStorage.removeItem(MARKER_KEY);seed();location.reload()}};
})();
`;
