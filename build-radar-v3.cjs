...
vm.runInThisContext(fs.readFileSync('visit-today-route-patch-v10_2.js','utf8'),{filename:'visit-today-route-patch-v10_2.js'});
...
html=window.patchRadarVisitTodayRouteV102(html);
...
if(!html.includes('radarTodayRouteV102')||!html.includes('9 paradas · 09:00')||!html.includes("'11055226','9845804','10821806'"))throw new Error('V10.2 today visit route missing');
