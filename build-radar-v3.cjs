...
vm.runInThisContext(fs.readFileSync('tuesday-weekly-route-hotfix-v10_8.js','utf8'),{filename:'tuesday-weekly-route-hotfix-v10_8.js'});
...
html=window.patchRadarTuesdayWeeklyV108(html);
...
if(!html.includes('radarTuesdayWeeklyV108')||!html.includes('Abrir ruta completa (13)')||!html.includes('5 dentales listos:')||!html.includes("session=loadSession()||newSession('auto')"))throw new Error('V10.8 Tuesday weekly/visits route consistency missing');
